---
title: "Get Started with SpinAI in 5 Minutes"
sidebarTitle: "Quickstart"
description: "Clone the SpinAI repo, connect a Supabase project, configure your environment variables, and spin your first roulette wheel — all running locally."
---
...
<Steps>
  ...
  <Step title="Create your Supabase project and run migrations">
    ...
    The migration enables the `pgcrypto` extension, creates all four tables with UUID primary keys, and applies `anon full access` RLS policies so the app can read and write using the public anon key.

    <Info>
      To enable per-member email notifications after the initial migration, add the email column if it isn't already present:
