---
title: "Send Manual Meeting Notifications from SpinAI"
sidebarTitle: "Manual"
description: "Trigger an immediate email notification from the SpinAI home screen or the POST /api/notify endpoint to alert your team about the next presenter."
---
