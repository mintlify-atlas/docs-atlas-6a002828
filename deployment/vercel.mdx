---
title: "Deploy SpinAI to Vercel: Environment and Build Configuration"
sidebarTitle: "Vercel"
description: "Set up SpinAI on Vercel: supply all seven required environment variables, confirm the Next.js framework preset, and deploy in minutes."
---
