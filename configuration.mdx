...
description: "Complete reference for every SpinAI environment variable, covering Supabase connection, PIN/JWT authentication, Gmail SMTP, and the GitHub Actions cron secret."
---
